...
export function activate(context: vscode.ExtensionContext) {
	...
	// 	if (vscode.workspace.workspaceFolders) {
			...
			const cmake_third_lib = vscode.commands.registerCommand('cmake-project-template.cmake-third-lib', () => {
				vscode.window.showInformationMessage('CMake Third Lib!');
				init.initialize_cmake_third_lib();
			});
			const cmake_third_lib_example = vscode.commands.registerCommand('cmake-project-template.cmake-third-lib-example', () => {
